...
| KILL | 0 | 0 | 0 |
| P0 | 0 | 0 | 0 |
| average userWouldInsert | 3.88 | 3.88 | 0.00 |
...
| --- | --- | --- | --- | --- | --- |
| 4. competitor analysis | founder_strategy | FIX | 2 | P1 | 경쟁사 분석해줘 |
| 15. service name ideas | generic | FIX | 2 | P1 | 서비스 이름 아이디어 줘 |
| 3. new feature prd | product_pm | FIX | 3 | P1 | 새 기능 PRD 써줘 |
| 7. investor update email | sales_bd | FIX | 3 | P1 | 투자자에게 업데이트 메일 써줘 |
| 8. customer price increase email | customer_support | FIX | 3 | P1 | 고객에게 가격 인상 안내 메일 써줘 |
...
| 25. generic job posting | hr_recruiting | FIX | 3 | P1 | 채용 공고 써줘 |
